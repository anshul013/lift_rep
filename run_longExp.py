...
parser.add_argument('--hidden_size', type=int, default=256, help='hidden dimension size for MLP blocks')
parser.add_argument('--single_layer_mixer', type=str_to_bool, default=False, help='whether to use single layer in mixer blocks')
    ...
    if args.is_training:
        ...
        for ii in range(args.itr):
            ...
            if args.model == 'TSMixer':
                setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_lr{}_nb{}_hs{}_dp{}_act{}_{}_{}'.format(
                    args.model_id,
                    args.data,
                    args.features,
                    args.seq_len,
            ...
            if args.pretrain:
                if args.model == 'TSMixer':
                    pretrain_setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_lr{}_nb{}_hs{}_dp{}_act{}_{}_{}'.format(
                        args.model_id,
